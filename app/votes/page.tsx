...
export default function VotesPage() {
  ...
  const totalVotes = mockVotes.reduce((sum, v) => sum + v.votes, 0)
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold mt-1">One Step Beyond</p>
                <p className="text-sm text-success">2,450 votes</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold mt-1">3 Series</p>
